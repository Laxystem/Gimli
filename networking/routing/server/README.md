...
# [Project: Gimli Networking Routing](../README.md) Server
...
dependencies {
    implementation("quest.laxla.gimli:networking-routing-server:0.0.1-alpha.3")
}
```
...
<dependencies>
    <dependency>
    	...
    	<artifactId>networking-routing-server</artifactId>
