...
public actual typealias Locale = String

@Serializable(with = LanguageCodeSerializer::class)
public actual open class LanguageCode internal actual constructor(internal actual val locale: Locale) {
    actual override fun toString(): String = locale
}

public actual fun String.toLanguageCode(): LanguageCode = LanguageCode(locale = this)
