...
# [Project: Gimli Utilities](../README.md) KotlinX Coroutines
...
dependencies {
    implementation("quest.laxla.gimli:util-coroutines:0.0.1-alpha.3")
}
```
...
<dependencies>
    <dependency>
    	...
    	<artifactId>util-coroutines</artifactId>
